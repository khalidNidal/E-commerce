        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
          ...
          /*  modelBuilder.Entity<Categories>().HasData(
            ...
            modelBuilder.Entity<LocalUser>().HasData(
                new LocalUser { Id = 1, FirstName = "Ahmed Haggag", UserName = "Haggag281", Password = "password123", Role = "Admin" },
                new LocalUser { Id = 2, FirstName = "Tarek Sharim", UserName = "Tarek777", Password = "password456", Role = "User" }
            );
